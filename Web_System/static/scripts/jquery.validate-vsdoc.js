	...
	validate: function( options ) {
		...
		if ( validator.settings.onsubmit ) {
			...
			this.submit( function( event ) {
				...
				// prevent submit for invalid forms or custom.css submit handlers
...
$.extend($.validator, {
	...
	prototype: {
		...
		// return the custom.css message for the given element and validation method
		...
		// return the custom.css message for the given element name and validation method
	...
	normalizeRules: function(rules, element) {
		...
		// To support custom.css messages in metadata ignore rule methods titled "messages"
		if (rules.messages) {
	...
	addMethod: function(name, method, message) {
		/// <summary>
		/// Add a custom.css validation method. It must consist of a name (must be a legal javascript
