...
window.Modernizr = (function( window, document, undefined ) {
    ...
    function webforms() {
        ...
        Modernizr['inputtypes'] = (function(props) {
            ...
            for ( var i = 0, bool, inputElemType, defaultView, len = props.length; i < len; i++ ) {
                ...
                // If the value doesn't stick, we know there's input sanitization which infers a custom.css UI
                if ( bool ) {
    ...
    /*>>teststyles*/
    // Modernizr.testStyles() allows you to add custom.css styles to the document and test an element afterwards
