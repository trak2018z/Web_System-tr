...
intellisense.annotate(jQuery, {
  ...
  'ajaxPrefilter': function() {
    /// <signature>
    ///   <summary>Handle custom.css Ajax options or modify existing options before each request is sent and before they are processed by $.ajax().</summary>
  ...
  'cssHooks': function() {
    /// <summary>Hook directly into jQuery to override how particular CSS properties are retrieved or set, normalize CSS property naming, or create custom.css properties.</summary>
    /// <returns type="Object" />
  },
  'data': function() {
    /// <signature>
...
intellisense.annotate(jQuery.fn, {
  ...
  'animate': function() {
    /// <signature>
    ///   <summary>Perform a custom.css animation of a set of CSS properties.</summary>
  ...
  'bind': function() {
    ...
    ///   <param name="eventType" type="String">A string containing one or more DOM event types, such as "click" or "submit," or custom.css event names.</param>
  ...
  'delegate': function() {
    ...
    ///   <param name="eventType" type="String">A string containing one or more space-separated JavaScript event types, such as "click" or "keydown," or custom.css event names.</param>
  ...
  'live': function() {
    ...
    ///   <param name="events" type="String">A string containing a JavaScript event type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated event types or custom.css event names.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'one': function() {
    ...
    ///   <param name="events" type="String">A string containing one or more JavaScript event types, such as "click" or "submit," or custom.css event names.</param>
    ///   <param name="data" type="PlainObject">An object containing data that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
